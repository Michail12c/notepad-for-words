...
const Explication = ({itemList, newList}) => {
  return(
    <div className = {style.explication}>
      ...
      {itemList === 0 ?  <div><p>В <b>Режимі уроку</b> ви можете обрати спосіб тренування своїх навиків. У <b>легкому режимі</b> ви повторюєте слова без перевірки. В <b>строгому режимі</b> потрібно ввести точний переклад фрази. В <b>режимі пазлу</b> ви зможете скласти переклад фрази зі слів - підказок </p>
